...
export const metadata: Metadata = {
  ...
  description: "How Safawala Sri Lanka collects, uses and protects the information you share with us.",
  alternates: { canonical: "https://safawalasrilanka.com/privacy" },
};
      ...
      <main className="subpage-main">
        <section className="subpage-hero section-shell">
          <div>
            ...
            <p>How Safawala Sri Lanka collects, uses and protects the information you share with us. Last updated 25 August 2026.</p>
          </div>
        </section>
