...
const searchLinks = [
  ["wedding safa wala in Sri Lanka", "/services/wedding-safa-tying"],
  ["professional safa tying", "/services/wedding-safa-tying"],
  ["groom pagdi Sri Lanka", "/services/groom-pagdi"],
    ...
    <section className="explore-section landing-explore section-shell" id="areas" aria-label="Explore Safawala service pages">
      <div className="explore-card">
        <div className="explore-card-head">
          <div><h2>Areas we serve in Sri Lanka</h2><p>{locations.length} locations across Sri Lanka and nearby destinations.</p></div>
