...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://sharmajisafawala.com/services/${slug}` },
  };
}
...
export default async function ServicePage({ params }: Props) {
  ...
  const breadcrumbSchema = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Services", item: "https://sharmajisafawala.com/#services" },
    { "@type": "ListItem", position: 3, name: service.name, item: `https://sharmajisafawala.com/services/${service.slug}` },
  ] };
