...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (location) {
    return {
      ...
      alternates: { canonical: `https://sharmajisafawala.com/${location.slug}` },
    };
  }
  ...
  if (page) {
    return {
      ...
      alternates: { canonical: `https://sharmajisafawala.com/${slug}` },
    };
  }
  return {};
}
...
export default async function AreaOrKeywordPage({ params }: Props) {
  ...
  if (location) {
    ...
    const breadcrumbSchema = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
      { "@type": "ListItem", position: 1, name: "Home", item: "https://sharmajisafawala.com/" },
      { "@type": "ListItem", position: 2, name: "Service areas", item: "https://sharmajisafawala.com/#areas" },
      { "@type": "ListItem", position: 3, name: location.name, item: `https://sharmajisafawala.com/${location.slug}` },
    ] };
  ...
  const breadcrumbSchema = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    { "@type": "ListItem", position: 1, name: "Home", item: "https://sharmajisafawala.com/" },
    { "@type": "ListItem", position: 2, name: page.title, item: `https://sharmajisafawala.com/${slug}` },
  ] };
