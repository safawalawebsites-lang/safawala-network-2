...
const searchLinks = [
  ["wedding safa wala in Vadodara", "/services/wedding-safa-tying"],
  ["professional safa tying", "/services/wedding-safa-tying"],
  ["groom pagdi Vadodara", "/services/groom-pagdi"],
    ...
    <section className="explore-section landing-explore section-shell" id="areas" aria-label="Explore Safawala service pages">
      <div className="explore-card">
        <div className="explore-card-head">
          <div><h2>Areas we serve in Vadodara</h2><p>{locations.length} locations across Vadodara and nearby destinations.</p></div>
