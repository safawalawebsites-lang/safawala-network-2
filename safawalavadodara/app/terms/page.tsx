...
export const metadata: Metadata = {
  ...
  description: "The terms that apply when you enquire about or book Safawala Vadodara's wedding safa and pagdi styling services.",
  alternates: { canonical: "https://safawalavadodara.com/terms" },
};
      ...
      <main className="subpage-main">
        <section className="subpage-hero section-shell">
          <div>
            ...
            <p>The terms that apply when you enquire about or book Safawala Vadodara's wedding safa and pagdi styling services. Last updated 25 August 2026.</p>
          </div>
        </section>
        ...
        <section className="subpage-content section-shell">
          <div>
            <h2>Our services</h2>
            <p>Professional wedding safa and groom pagdi styling across Vadodara and nearby destinations. These terms apply to enquiries and bookings made through this website, by phone or over WhatsApp.</p>
            ...
            <p>Safawala Vadodara takes care in planning and styling for your event. To the extent permitted by law, we are not liable for delays or issues caused by circumstances outside our reasonable control, such as venue access, weather or traffic.</p>
            <h2>Governing law</h2>
