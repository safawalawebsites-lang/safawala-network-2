...
export const metadata: Metadata = {
  title: "Designer Wedding Safa in Vadodara | Groom & Baraati Safa | Safawala",
  description:
    "Explore designer wedding safa in Vadodara for grooms, family, baraat members and wedding guests. Find royal pagdi, traditional safa, Rajasthani & Gujarati styles, kalgi and groom accessories at Safawala.",
