...
export default function InquiryForm({ pageName, areaPlaceholder = "Venue or area" }: Props) {
  function submitInquiry(event: FormEvent<HTMLFormElement>) {
    ...
    const message = [
      `Hello Safawala Seychelles, I want to check availability for ${pageName}.`,
      `Name: ${data.get("name")}`,
  ...
  return (
    <aside className="quote-card landing-quote" aria-labelledby="landing-quote-heading">
      ...
      <p>Share the essentials and continue directly with our Seychelles safa team on WhatsApp.</p>
