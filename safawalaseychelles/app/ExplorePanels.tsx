...
const searchLinks = [
  ["wedding safa wala in Seychelles", "/services/wedding-safa-tying"],
  ["professional safa tying", "/services/wedding-safa-tying"],
  ["groom pagdi Seychelles", "/services/groom-pagdi"],
    ...
    <section className="explore-section landing-explore section-shell" id="areas" aria-label="Explore Safawala service pages">
      <div className="explore-card">
        <div className="explore-card-head">
          <div><h2>Areas we serve in Seychelles</h2><p>{locations.length} locations across Seychelles and nearby destinations.</p></div>
