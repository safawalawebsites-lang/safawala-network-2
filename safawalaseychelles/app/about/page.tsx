...
export const metadata: Metadata = {
  title: "About Safawala Seychelles",
  description: "Professional wedding safa and groom pagdi styling across Seychelles and nearby destinations. Learn how Safawala Seychelles works, from first enquiry to the wedding day.",
  alternates: { canonical: "https://safawalaseychelles.com/about" },
};
      ...
      <main className="subpage-main">
        <section className="subpage-hero section-shell">
          <div>
            ...
            <h1>About Safawala Seychelles</h1>
            <p>Professional wedding safa and groom pagdi styling across Seychelles and nearby destinations.</p>
          </div>
