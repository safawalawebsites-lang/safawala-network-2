...
export const metadata: Metadata = {
  metadataBase: new URL("https://safawalaseychelles.com"),
  title: { default: "Safawala Seychelles", template: "%s | Safawala Seychelles" },
  description: "Professional wedding safa and groom pagdi styling across Seychelles and nearby destinations.",
  icons: {
    icon: [
  ...
  openGraph: {
    images: [{ url: "/og.png", width: 1745, height: 909, alt: "Safawala Seychelles — Wedding Safa, tied with care." }],
  },
