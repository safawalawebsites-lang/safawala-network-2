...
const faq = [
  ["How much does a bespoke groom pagdi creation cost?", "Pricing depends on the design complexity, fabric, accessories and time available for planning. Share your outfit references and date for a tailored quote."],
  ["Do you provide bespoke styling at hotels and resorts?", "Yes. Our artists travel to hotels, resorts, homes and wedding venues to deliver the finished bespoke creation on the day."],
...
export default function HomeClient() {
  ...
  function submitInquiry(event: FormEvent<HTMLFormElement>) {
    ...
    const message = [
      "Hello SR Grooms Creations, I would like to check wedding safa availability.",
      `Name: ${data.get("name")}`,
  ...
  return (
    <>
      <header className="site-header">
        <a className="brand" href="#top" aria-label="SR Grooms Creations home">
          <span className="brand-logo-window"><img src="/safawala-logo-current.png" alt="Safawala" /></span><small>CREATIONS</small>
        </a>
      ...
      <main id="top">
        <section className="hero section-shell">
          <div className="hero-copy">
            <p className="eyebrow">Bespoke Groom Pagdi Creations</p>
            <h1>Every Pagdi, A New Creation.</h1>
            <p className="hero-lede">SR Grooms Creations designs and ties bespoke wedding safas, built fold by fold around the groom's outfit, face profile and the story he wants his pagdi to tell.</p>
            ...
            <div className="hero-photo">
              ...
              <div className="photo-note"><span>Serving SR Grooms Creations & nearby destinations</span><strong>31 unique locations</strong></div>
            </div>
          </div>
        ...
        <section className="seo-intro section-shell" aria-labelledby="rishikesh-safa-heading">
          <div className="seo-intro-heading">
            <p className="eyebrow">Bespoke wedding safa design</p>
            <h2 id="rishikesh-safa-heading">Bespoke wedding safa creations, not off-the-shelf turbans.</h2>
          </div>
          <div className="seo-intro-copy"><p>SR Grooms Creations provides <strong>custom wedding safa design, groom pagdi styling and professional turban tying</strong> for grooms who want a distinctly personal look. Every fold, fabric and accessory placement is planned around the individual outfit rather than a repeated template.</p><p>Grooms and families can share outfit references, jewellery and the intended mood so the team can propose a bespoke pagdi creation, quantity and tying team for the full wedding party.</p></div>
        ...
        <section className="editorial section-shell">
          ...
          <div className="editorial-copy"><p className="eyebrow">Bespoke design planning</p><h2>Calm preparation before the celebration begins.</h2><p>A one-off pagdi creation needs more lead time than a standard booking, so a bespoke safa service only works well when the design direction is agreed early.</p><p>We confirm the venue, reporting time and preparation room before the event. The groom receives an unhurried, detailed design and styling slot; family and baraatis follow in planned batches.</p><ul><li>On-location hotel, resort and home service</li><li>Groom, family and baraati styling plans</li><li>Colour coordination from outfit references</li><li>Travel planning for nearby destinations</li></ul></div>
        </section>
