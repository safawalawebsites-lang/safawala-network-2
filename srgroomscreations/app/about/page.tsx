...
export const metadata: Metadata = {
  title: "About SR Grooms Creations",
  description: "Bespoke groom pagdis and coordinated wedding safas, created and tied at your venue for a truly one-off look. Learn how SR Grooms Creations works, from first enquiry to the wedding day.",
  alternates: { canonical: "https://srgroomscreations.in/about" },
};
      ...
      <main className="subpage-main">
        <section className="subpage-hero section-shell">
          <div>
            ...
            <h1>About SR Grooms Creations</h1>
            <p>Bespoke groom pagdis and coordinated wedding safas, created and tied at your venue for a truly one-off look.</p>
          </div>
        ...
        <section className="subpage-content section-shell">
          <div>
            ...
            <p>Pricing is never a flat, generic number. It's built from your actual guest count, the fabric you choose, the complexity of the fold or style, and how far the team needs to travel — so the quote reflects your event rather than an average one.</p>
          </div>
