    ...
    <footer className="site-footer">
      <div className="footer-main section-shell">
        <div className="footer-signature">
          <a className="brand footer-brand" href="/" aria-label="SR Grooms Creations home">
          ...
          <p>Refined groom pagdis and coordinated wedding safas, styled at your venue across SR Grooms Creations and nearby destinations.</p>
        ...
        <div className="footer-contact">
          ...
          <p>Bespoke design & tying, on-location</p>
          <p>Monday–Saturday<br />10:00–19:00</p>
        </div>
      </div>

      <div className="footer-bottom section-shell">
        <span>© 2026 SR Grooms Creations</span>
