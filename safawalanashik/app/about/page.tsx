...
export const metadata: Metadata = {
  title: "About Safawala Nashik",
  description: "Professional wedding safa and groom pagdi styling across Nashik and nearby destinations. Learn how Safawala Nashik works, from first enquiry to the wedding day.",
  alternates: { canonical: "https://safawalanashik.com/about" },
};
      ...
      <main className="subpage-main">
        <section className="subpage-hero section-shell">
          <div>
            ...
            <h1>About Safawala Nashik</h1>
            <p>Professional wedding safa and groom pagdi styling across Nashik and nearby destinations.</p>
          </div>
