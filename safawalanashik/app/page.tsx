...
export const metadata: Metadata = {
  title: "Designer Wedding Safa in Nashik | Groom & Baraati Safa | Safawala",
  description:
    "Explore designer wedding safa in Nashik for grooms, family, baraat members and wedding guests. Find royal pagdi, traditional safa, Rajasthani & Gujarati styles, kalgi and groom accessories at Safawala.",
