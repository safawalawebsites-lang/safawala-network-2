...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: service.title,
    description: truncateDescription(`${service.intro} Check Safawala Nashik availability for your wedding date.`),
    alternates: { canonical: `https://safawalanashik.com/services/${slug}` },
  };
}
...
export default async function ServicePage({ params }: Props) {
  ...
  const breadcrumbSchema = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Services", item: "https://safawalanashik.com/#services" },
    { "@type": "ListItem", position: 3, name: service.name, item: `https://safawalanashik.com/services/${service.slug}` },
  ] };
