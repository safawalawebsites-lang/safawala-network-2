...
export const metadata: Metadata = {
  ...
  description: "How Safawala Thailand collects, uses and protects the information you share with us.",
  alternates: { canonical: "https://safawalathailand.com/privacy" },
};
      ...
      <main className="subpage-main">
        <section className="subpage-hero section-shell">
          <div>
            ...
            <p>How Safawala Thailand collects, uses and protects the information you share with us. Last updated 25 August 2026.</p>
          </div>
        </section>
