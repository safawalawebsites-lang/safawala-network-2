...
const faq = [
  ["How much does a wedding safa tying service cost in Thailand?", "Pricing depends on the number of safas, selected fabric, accessories, venue location and time available for tying. Send your date, venue and approximate headcount for a tailored quote."],
  ["Do you provide safa tying at Thailand hotels and resorts?", "Yes. Our artists travel to hotels, resorts, homes and wedding venues across Thailand, Sukhumvit, Silom, Sathorn and the wider service area."],
  ...
  ["Do you travel from Thailand to Patong, Karon or Kata?", "Yes, subject to date and travel availability. Nearby-city bookings are planned as outstation assignments with the venue pin and reporting time confirmed in advance."],
];
...
export default function HomeClient() {
  ...
  function submitInquiry(event: FormEvent<HTMLFormElement>) {
    ...
    const message = [
      "Hello Safawala Thailand, I would like to check wedding safa availability.",
      `Name: ${data.get("name")}`,
  ...
  return (
    <>
      <header className="site-header">
        <a className="brand" href="#top" aria-label="Safawala Thailand home">
          <span className="brand-logo-window"><img src="/safawala-logo-current.png" alt="Safawala" /></span><small>THAILAND</small>
        </a>
      ...
      <main id="top">
        <section className="hero section-shell">
          <div className="hero-copy">
            <p className="eyebrow">Thailand Wedding Safa Specialists</p>
            <h1>Royal Safas. Perfectly Styled.</h1>
            <p className="hero-lede">Expert groom pagdi and coordinated baraati safa service, delivered to your hotel, resort or wedding venue across Thailand.</p>
            ...
            <div className="hero-photo">
              ...
              <div className="photo-note"><span>Serving Thailand & nearby destinations</span><strong>34 unique locations</strong></div>
            </div>
          </div>
          ...
          <aside className="quote-card" id="quote" aria-labelledby="quote-heading">
            ...
            <form onSubmit={submitInquiry}>
              ...
              <label>Venue or area<input name="area" required placeholder="e.g. Sukhumvit, Silom" /></label>
        ...
        <section className="content-section section-shell" id="services">
          <div className="section-heading"><div><p className="eyebrow">Made for the whole wedding party</p><h2>One polished look. Every guest ready on time.</h2></div><p>Our professional safa tying service in Thailand is organised around your headcount, photography and baraat departure—not a rushed one-size-fits-all appointment.</p></div>
        ...
        <section className="seo-intro section-shell" aria-labelledby="rishikesh-safa-heading">
          <div className="seo-intro-heading">
            ...
            <h2 id="rishikesh-safa-heading">Professional wedding safa tying in Thailand, planned from fabric to final fold.</h2>
          </div>
          <div className="seo-intro-copy">
            <p>Safawala Thailand provides <strong>wedding safa rental, groom pagdi styling and professional turban tying</strong> for local and destination weddings. Instead of sending loose turbans without a plan, our on-site safa tying artists work around the groom’s ready time, the baraat departure, photography and the number of guests who must be prepared together.</p>
            <p>Couples searching for a <strong>safa wala in Thailand</strong>, a groom safa specialist or a complete baraati safa service can coordinate the fabric, colour, style, quantity and tying team in one enquiry. The service can cover the groom, fathers, brothers, close family, groomsmen and the full wedding party.</p>
          </div>
        ...
        <section className="editorial section-shell">
          ...
          <div className="editorial-copy"><p className="eyebrow">Thailand wedding planning</p><h2>Calm preparation before the celebration begins.</h2><p>Destination weddings around Sukhumvit, Silom, Sathorn and the Thailand hospitality belt often spread guests across rooms, cottages and separate properties. A beautiful safa service only works when the logistics are equally refined.</p><p>We confirm the venue pin, reporting time, final headcount and preparation room before the event. The groom receives an unhurried styling slot; family and baraatis follow in planned batches with enough artists to protect the schedule.</p><ul><li>On-location hotel, resort and home service</li><li>Groom, family and baraati styling plans</li><li>Colour coordination from outfit references</li><li>Travel planning for nearby destinations</li></ul></div>
        </section>

        <section className="styles-section section-shell" aria-labelledby="styles-heading">
          <div className="section-heading"><div><p className="eyebrow">Styles, fabrics and colours</p><h2 id="styles-heading">A wedding safa collection for traditional and modern Thailand celebrations.</h2></div><p>Choose the direction first, then refine the fabric and colour against the groom’s sherwani, family outfits, floral palette and venue lighting.</p></div>
        ...
        <section className="keyword-section section-shell">
          <div className="keyword-panel">
            <div>
              ...
              <h2>What people search for before booking a safa wala in Thailand.</h2>
        ...
        <section className="seo-guide">
          <div className="section-shell">
            ...
            <div className="guide-grid">
              ...
              <article><span>02</span><h3>Destination logistics</h3><p>For Thailand hotels, resorts and nearby hill venues, we plan the arrival buffer, preparation room and tying sequence so the groom and baraatis are ready on time.</p></article>
        ...
        <section className="explore-section section-shell" id="areas" aria-label="Explore Thailand service pages">
          <article className="explore-card">
            <div className="explore-card-head"><div><h2>Areas we serve in Thailand</h2><p>{allLocations.length} locations across Thailand and nearby destinations.</p></div><button type="button" onClick={() => setExpandedAreas((value) => !value)} aria-expanded={expandedAreas}>{expandedAreas ? "View less" : "View more"}</button></div>
        ...
        <section className="faq-section section-shell" id="faq">
          <div className="section-heading"><div><p className="eyebrow">Thailand FAQs</p><h2>Questions couples ask before booking.</h2></div><p>These answers are specific to the Thailand service model. Location and service pages use separate question sets.</p></div>
