...
export const metadata: Metadata = {
  title: "About Safawala Thailand",
  description: "Professional wedding safa and groom pagdi styling across Thailand and nearby destinations. Learn how Safawala Thailand works, from first enquiry to the wedding day.",
  alternates: { canonical: "https://safawalathailand.com/about" },
};
      ...
      <main className="subpage-main">
        <section className="subpage-hero section-shell">
          <div>
            ...
            <h1>About Safawala Thailand</h1>
            <p>Professional wedding safa and groom pagdi styling across Thailand and nearby destinations.</p>
          </div>
