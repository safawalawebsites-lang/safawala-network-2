    ...
    <footer className="site-footer">
      <div className="footer-main section-shell">
        <div className="footer-signature">
          <a className="brand footer-brand" href="/" aria-label="SR Grooms home">
            <span className="brand-logo-window"><img src="/safawala-logo-current.png" alt="Safawala" /></span>
            <small>SR GROOMS</small>
          </a>
          <h2>Tradition, tied beautifully.</h2>
          <p>Refined groom pagdis and coordinated wedding safas, styled at your venue across SR Grooms and nearby destinations.</p>
        ...
        <div className="footer-contact">
          ...
          <p>On-location groom styling, pan-India</p>
          <p>Monday–Saturday<br />10:00–19:00</p>
        </div>
      </div>

      <div className="footer-bottom section-shell">
        <span>© 2026 SR Grooms</span>
