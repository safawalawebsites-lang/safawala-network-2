...
const faq = [
  ["How much does groom pagdi styling cost?", "Pricing depends on the number of safas, selected fabric, accessories and time available for styling. Send your date, venue and approximate headcount for a tailored quote."],
  ["Do you provide styling at hotels and resorts?", "Yes. Our artists travel to hotels, resorts, homes and wedding venues across the city and nearby service area."],
...
export default function HomeClient() {
  ...
  function submitInquiry(event: FormEvent<HTMLFormElement>) {
    ...
    const message = [
      "Hello SR Grooms, I would like to check wedding safa availability.",
      `Name: ${data.get("name")}`,
  ...
  return (
    <>
      <header className="site-header">
        <a className="brand" href="#top" aria-label="SR Grooms home">
          <span className="brand-logo-window"><img src="/safawala-logo-current.png" alt="Safawala" /></span><small>SR GROOMS</small>
        </a>
      ...
      <main id="top">
        <section className="hero section-shell">
          <div className="hero-copy">
            <p className="eyebrow">Complete Groom Styling Studio</p>
            <h1>Grooms, Styled Completely.</h1>
            <p className="hero-lede">SR Grooms brings safa tying, pagdi styling and finishing detail together into one complete groom styling appointment — before the sherwani ever leaves the room.</p>
            ...
            <div className="hero-photo">
              ...
              <div className="photo-note"><span>Serving SR Grooms & nearby destinations</span><strong>31 unique locations</strong></div>
            </div>
          </div>
        ...
        <section className="seo-intro section-shell" aria-labelledby="rishikesh-safa-heading">
          <div className="seo-intro-heading">
            <p className="eyebrow">Complete groom pagdi styling</p>
            <h2 id="rishikesh-safa-heading">One studio for complete groom styling, not just the safa.</h2>
          </div>
          <div className="seo-intro-copy"><p>SR Grooms provides <strong>wedding safa rental, groom pagdi styling and professional turban tying</strong>, reviewed alongside the sherwani, jewellery and overall groom look. Instead of a rushed final-hour turban, the groom receives a dedicated, unhurried styling session.</p><p>Grooms and families can coordinate the fabric, colour, style, quantity and tying team in one enquiry — covering the groom, fathers, brothers, close family, groomsmen and the full wedding party.</p></div>
        ...
        <section className="editorial section-shell">
          ...
          <div className="editorial-copy"><p className="eyebrow">Groom styling planning</p><h2>Calm preparation before the celebration begins.</h2><p>A groom's final look depends on more than the turban alone, so a safa service only works well when it is planned alongside the sherwani, jewellery and portrait schedule.</p><p>We confirm the venue, reporting time and preparation room before the event. The groom receives an unhurried, detailed styling slot; family and baraatis follow in planned batches.</p><ul><li>On-location hotel, resort and home service</li><li>Groom, family and baraati styling plans</li><li>Colour coordination from outfit references</li><li>Travel planning for nearby destinations</li></ul></div>
        </section>
