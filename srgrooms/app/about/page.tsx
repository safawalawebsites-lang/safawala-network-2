...
export const metadata: Metadata = {
  title: "About SR Grooms",
  description: "Complete groom pagdi styling and coordinated wedding safas, delivered at your hotel, resort or wedding venue. Learn how SR Grooms works, from first enquiry to the wedding day.",
  alternates: { canonical: "https://srgrooms.com/about" },
};
      ...
      <main className="subpage-main">
        <section className="subpage-hero section-shell">
          <div>
            ...
            <h1>About SR Grooms</h1>
            <p>Complete groom pagdi styling and coordinated wedding safas, delivered at your hotel, resort or wedding venue.</p>
          </div>
