...
export const metadata: Metadata = {
  title: "About Safawala Surat",
  description: "Professional wedding safa and groom pagdi styling across Surat and nearby destinations. Learn how Safawala Surat works, from first enquiry to the wedding day.",
  alternates: { canonical: "https://safawalasurat.com/about" },
};
      ...
      <main className="subpage-main">
        <section className="subpage-hero section-shell">
          <div>
            ...
            <h1>About Safawala Surat</h1>
            <p>Professional wedding safa and groom pagdi styling across Surat and nearby destinations.</p>
          </div>
