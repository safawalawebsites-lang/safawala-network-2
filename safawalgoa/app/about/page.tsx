...
export const metadata: Metadata = {
  title: "About Safawala Goa",
  description: "Professional wedding safa and groom pagdi styling across Goa and nearby destinations. Learn how Safawala Goa works, from first enquiry to the wedding day.",
  alternates: { canonical: "https://safawalgoa.com/about" },
};
      ...
      <main className="subpage-main">
        <section className="subpage-hero section-shell">
          <div>
            ...
            <h1>About Safawala Goa</h1>
            <p>Professional wedding safa and groom pagdi styling across Goa and nearby destinations.</p>
          </div>
