...
export const metadata: Metadata = {
  ...
  description: "The terms that apply when you enquire about or book Safawala Goa's wedding safa and pagdi styling services.",
  alternates: { canonical: "https://safawalgoa.com/terms" },
};

export default function TermsPage() {
  return (
    <>
      <header className="site-header"><a className="brand" href="/" aria-label="Safawala Goa home"><span className="brand-logo-window"><img src="/safawala-logo-current.png" alt="Safawala" /></span><small>GOA</small></a><nav aria-label="Page navigation"><a href="/">Home</a><a href="/about">About</a><a href="/privacy">Privacy Policy</a><a href="/terms">Terms of Service</a></nav></header>
      ...
      <main className="subpage-main">
        <section className="subpage-hero section-shell">
          <div>
            ...
            <p>The terms that apply when you enquire about or book Safawala Goa's wedding safa and pagdi styling services. Last updated 25 August 2026.</p>
          </div>
        </section>
        ...
        <section className="subpage-content section-shell">
          <div>
            <h2>Our services</h2>
            <p>Professional wedding safa and groom pagdi styling across Goa and nearby destinations. These terms apply to enquiries and bookings made through this website, by phone or over WhatsApp.</p>
            ...
            <p>Safawala Goa takes care in planning and styling for your event. To the extent permitted by law, we are not liable for delays or issues caused by circumstances outside our reasonable control, such as venue access, weather or traffic.</p>
            <h2>Governing law</h2>
