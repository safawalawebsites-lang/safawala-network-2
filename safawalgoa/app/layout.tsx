...
export const metadata: Metadata = {
  metadataBase: new URL("https://safawalgoa.com"),
  title: { default: "Safawala Goa", template: "%s | Safawala Goa" },
  description: "Professional wedding safa and groom pagdi styling across Goa and nearby destinations.",
  icons: {
    icon: [
  ...
  openGraph: {
    images: [{ url: "/og.png", width: 1745, height: 909, alt: "Safawala Goa — Wedding Safa, tied with care." }],
  },
