...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${page.title}`,
    description: truncateDescription(`${page.intro} Check Safawala Goa availability for your wedding date.`),
    alternates: { canonical: `https://safawalgoa.com/keywords/${slug}` },
  };
}
...
export default async function KeywordPage({ params }: Props) {
  ...
  const breadcrumbSchema = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: page.title, item: `https://safawalgoa.com/keywords/${slug}` },
  ] };
