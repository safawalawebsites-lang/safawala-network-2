...
export const metadata: Metadata = {
  title: "About Safawala Rishikesh",
  description: "Professional wedding safa and groom pagdi styling across Rishikesh and nearby destinations. Learn how Safawala Rishikesh works, from first enquiry to the wedding day.",
  alternates: { canonical: "https://safawalarishikesh.com/about" },
};
      ...
      <main className="subpage-main">
        <section className="subpage-hero section-shell">
          <div>
            ...
            <h1>About Safawala Rishikesh</h1>
            <p>Professional wedding safa and groom pagdi styling across Rishikesh and nearby destinations.</p>
          </div>
