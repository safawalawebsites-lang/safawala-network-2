...
export const metadata: Metadata = {
  title: "About Safawala Vietnam",
  description: "Professional wedding safa and groom pagdi styling across Vietnam and nearby destinations. Learn how Safawala Vietnam works, from first enquiry to the wedding day.",
  alternates: { canonical: "https://safawalavietnam.com/about" },
};
      ...
      <main className="subpage-main">
        <section className="subpage-hero section-shell">
          <div>
            ...
            <h1>About Safawala Vietnam</h1>
            <p>Professional wedding safa and groom pagdi styling across Vietnam and nearby destinations.</p>
          </div>
