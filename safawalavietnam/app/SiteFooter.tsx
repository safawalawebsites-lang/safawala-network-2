    ...
    <footer className="site-footer">
      <div className="footer-main section-shell">
        <div className="footer-signature">
          <a className="brand footer-brand" href="/" aria-label="Safawala Vietnam home">
            <span className="brand-logo-window"><img src="/safawala-logo-current.png" alt="Safawala" /></span>
            <small>VIETNAM</small>
          </a>
          <h2>Tradition, tied beautifully.</h2>
          <p>Refined groom pagdis and coordinated wedding safas, styled at your venue across Vietnam and nearby destinations.</p>
      ...
      <div className="footer-bottom section-shell">
        <span>© 2026 Safawala Vietnam</span>
