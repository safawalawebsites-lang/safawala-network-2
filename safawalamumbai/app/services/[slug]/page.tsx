...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: service.title,
    description: truncateDescription(`${service.intro} Check Safawala Mumbai availability for your wedding date.`),
    alternates: { canonical: `https://safawalamumbai.com/services/${slug}` },
  };
}
...
export default async function ServicePage({ params }: Props) {
  ...
  const breadcrumbSchema = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Services", item: "https://safawalamumbai.com/#services" },
    { "@type": "ListItem", position: 3, name: service.name, item: `https://safawalamumbai.com/services/${service.slug}` },
  ] };
