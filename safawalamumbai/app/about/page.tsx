...
export const metadata: Metadata = {
  title: "About Safawala Mumbai",
  description: "Professional wedding safa and groom pagdi styling across Mumbai and nearby destinations. Learn how Safawala Mumbai works, from first enquiry to the wedding day.",
  alternates: { canonical: "https://safawalamumbai.com/about" },
};
      ...
      <main className="subpage-main">
        <section className="subpage-hero section-shell">
          <div>
            ...
            <h1>About Safawala Mumbai</h1>
            <p>Professional wedding safa and groom pagdi styling across Mumbai and nearby destinations.</p>
          </div>
