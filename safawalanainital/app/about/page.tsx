...
export const metadata: Metadata = {
  title: "About Safawala Nainital",
  description: "Professional wedding safa and groom pagdi styling across Nainital and nearby destinations. Learn how Safawala Nainital works, from first enquiry to the wedding day.",
  alternates: { canonical: "https://safawalanainital.com/about" },
};
      ...
      <main className="subpage-main">
        <section className="subpage-hero section-shell">
          <div>
            ...
            <h1>About Safawala Nainital</h1>
            <p>Professional wedding safa and groom pagdi styling across Nainital and nearby destinations.</p>
          </div>
