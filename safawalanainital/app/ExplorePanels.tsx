...
const searchLinks = [
  ["wedding safa wala in Nainital", "/services/wedding-safa-tying"],
  ["professional safa tying", "/services/wedding-safa-tying"],
  ["groom pagdi Nainital", "/services/groom-pagdi"],
    ...
    <section className="explore-section landing-explore section-shell" id="areas" aria-label="Explore Safawala service pages">
      <div className="explore-card">
        <div className="explore-card-head">
          <div><h2>Areas we serve in Nainital</h2><p>{locations.length} locations across Nainital and nearby destinations.</p></div>
