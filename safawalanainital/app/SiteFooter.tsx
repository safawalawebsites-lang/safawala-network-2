    ...
    <footer className="site-footer">
      <div className="footer-main section-shell">
        <div className="footer-signature">
          <a className="brand footer-brand" href="/" aria-label="Safawala Nainital home">
          ...
          <p>Refined groom pagdis and coordinated wedding safas, styled at your venue across Nainital and nearby destinations.</p>
      ...
      <div className="footer-bottom section-shell">
        <span>© 2026 Safawala Nainital</span>
