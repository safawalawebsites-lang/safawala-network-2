...
export const metadata: Metadata = {
  metadataBase: new URL("https://safawalanainital.com"),
  title: { default: "Safawala Nainital", template: "%s | Safawala Nainital" },
  description: "Professional wedding safa and groom pagdi styling across Nainital and nearby destinations.",
  icons: {
    icon: [
  ...
  openGraph: {
    images: [{ url: "/og.png", width: 1745, height: 909, alt: "Safawala Nainital — Wedding Safa, tied with care." }],
  },
