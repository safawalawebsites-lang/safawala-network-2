...
const faq = [
  ["How much does groom pagdi and safa styling cost?", "Pricing depends on the number of safas, selected fabric, accessories and time available for styling. Send your date, venue and approximate headcount for a tailored quote."],
...
export default function HomeClient() {
  ...
  function submitInquiry(event: FormEvent<HTMLFormElement>) {
    ...
    const message = [
      "Hello Wow Grooms, I would like to check wedding safa availability.",
      `Name: ${data.get("name")}`,
  ...
  return (
    <>
      <header className="site-header">
        <a className="brand" href="#top" aria-label="Wow Grooms home">
          <span className="brand-logo-window"><img src="/safawala-logo-current.png" alt="Safawala" /></span><small>WOW GROOMS</small>
        </a>
      ...
      <main id="top">
        <section className="hero section-shell">
          <div className="hero-copy">
            <p className="eyebrow">Grooms That Get The Wow</p>
            <h1>Wow Grooms. Perfectly Styled.</h1>
        ...
        <section className="seo-intro section-shell" aria-labelledby="rishikesh-safa-heading">
          <div className="seo-intro-heading">
            ...
            <h2 id="rishikesh-safa-heading">Wedding safa styling built for the reaction, not just the ritual.</h2>
          </div>
          <div className="seo-intro-copy"><p>Wow Grooms provides <strong>wedding safa rental, groom pagdi styling and professional turban tying</strong> for grooms who want to make an entrance. Instead of a generic turban, the groom's pagdi is planned around his sherwani, jewellery and the exact moment he'll be seen.</p><p>Families can coordinate the fabric, colour, style, quantity and tying team in one enquiry — covering the groom, close family, groomsmen and the full wedding party, so the whole baraat looks just as sharp.</p></div>
